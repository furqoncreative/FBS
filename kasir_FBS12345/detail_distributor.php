...
<body>
   ...
   <!--/content-inner-->
    ...
    <div class="col-sm-12">
        <div class="row">
            <h3> <?php echo $data['nama_distributor'];?> </h3>
        </div>
            
        <div class="form-group col-sm-12">
            <label class="col-sm-2 control-label">ID DISTRIBUTOR</label>
            <div class="col-sm-10">
              <p class="form-control-status-bar">: <?php echo $data['id_distributor'];?></p>
            </div>
        </div>
        <div class="form-group col-sm-12">
            <label class="col-sm-2 control-label">NAMA</label>
            <div class="col-sm-10">
              <p class="form-control-status-bar">: <?php echo $data['nama_distributor'];?></p>
            </div>
        </div>
        <div class="form-group col-sm-12">
        ...
        <div class="form-group col-sm-12">
            <a class="btn btn btn-danger" href="Data_Distributor.php">Back</a>
        </div>
    </div>                
</div>
					</div>
