...
$pdf->Ln();
$pdf->Cell(15);
$pdf->Cell(100,6,'_____________________________________________________',0,0,'C');

$pdf->Ln();
$pdf->Cell(15);
$pdf->Cell(100,6,'*** TERIMA KASIH SUDAH BELANJA DI FURQON BOOKS STORE ***',0,0,'C');

$pdf->Ln();
$pdf->Cell(15);
$pdf->Cell(100,4,'_____________________________________________________',0,0,'C');
