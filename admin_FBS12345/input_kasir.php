...
if(isset($_POST['tambahkasir'])) {
    ...
    if(tambahkasir($_POST)> 0 ) {
        ...
        echo "<script>
             alert('DATA KASIR BERHASIL DITAMBAH !');
             document.location.href='Data_Kasir.php';
             </script>"; 
         }
        else {
            echo "<script>
             alert('DATA KASIR GAGAL DITAMBAH !');
...
//koneksi berhsil
 ...
 $carikode = mysqli_query($koneksi, "SELECT max(id_kasir) from kasir") or die (mysql_error());
  // menjadikannya array
  ...
  if ($datakode) {
   ...
   $kode = $kode + 1;
   $kode_otomatis = "KSR-".str_pad($kode, 3, "0", STR_PAD_LEFT);
  } else {
   $kode_otomatis = "KSR-001";
  }
...
<div class="registration">
		...
		<h2><span><i class="fa fa-pencil"></i> Input Data Kasir Baru</span></h2>
		<script>
			(function() {
		 ...
		 <!-- Form -->
			<form method="POST" action="">
				<div>
					<label>
						<input placeholder="ID Kasir :" type="text" name="id_kasir" value="<?php echo $kode_otomatis;?>" readonly>
					</label>
				</div>
				<div>
					<label>
				...
				<div>
					<label>
						<input placeholder="No Telepon :" type="text" name="telepon" tabindex="3" required="">
					</label>
				</div>
				<div>
					<label>
						<input placeholder="Status :" type="text" name="status" tabindex="4">
					</label>
				</div>							
				<div>
					<input type="submit" name="tambahkasir" tabindex="8" value="SUBMIT">
					<input type="reset" tabindex="9" value="RESET">
				</div>
			<!-- /Form -->
		</div>
	</div>
	<div class="registration_left">
		<h2> .</h2>
		 ...
		 <!-- Form -->
				<div>
					<label>
						<input placeholder="Username :" type="text" name="username" tabindex="5" required="">
					</label>
				</div>	
				<div >
					<label>
						<input placeholder="Password :" type="Password" name="password" tabindex="6" required="">
					</label>
				</div>
				<div>
					<label>
