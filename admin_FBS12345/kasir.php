		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('#id_buku').change(function(){
					$.getJSON('kasir.php',{action:'getHarga', id_buku:$(this).val()}, function(json){
						if (json == null) {
							$('#judul').val('');
							$('#harga_jual').val('');
						} else {
				...
				<!--content-->
<div class="content">
<form method="POST" name="autoSumForm"  action="kasir.php">

						<!--//area-->
							<div class="col-md-6 chrt-three">
								<div class="col-md-12 monthly-grid">
									<h4>TOTAL TAGIHAN :</h4> 
									<input class = "form-control1" type ="text"  id="tagihan"  onFocus="startCalc();" onBlur="stopCalc();"  />
								</div>
								...
								<div class="col-md-6 chrt-three">
									<h5>KEMBALIAN :</h5>
									<input class = "form-control1" type ="text" id="kembali"  onchange='tryNumberFormat(this.form.thirdBox);' readonly="" />
								</div>
							</div>
...
<form method="post" action="cetak_struk.php">
			...
			<input class = "form-control" type ="search" id="jual"  name = "jual" required="" />
			</div>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="kasir.php"><i class="fa fa-shopping-cart"></i> <span>Kasir</span></a></li>
