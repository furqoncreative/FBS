...
<body>
   ...
   <!--/content-inner-->
	<div class="left-content">
	   <div class="inner-content">
		...
		<div class="fo-top-di">
			...
			<h2><i class="fa fa-users"></i>  Data Kasir</h2>
    ...
    <tr>
      ...
      <td><?php echo '<a class="btn btn-xs btn-info" href="detail_kasir.php?id_kasir='. $data['id_kasir'] . '"><i alt="detail" class="fa fa-eye"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-primary" href="edit_kasir.php?id_kasir='. $data['id_kasir'] . '"><i alt="edit" class="fa fa-edit"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-danger" href="hapus_kasir.php?id_kasir='. $data['id_kasir'] . '"><i alt="hapus" class="fa fa-eraser"></i></a>&nbsp';?>
      </td>
    <?php
    endforeach;
    ?>
