			...
			<div class="content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
						...
						$jual=query("SELECT COUNT(id_penjualan) FROM penjualan");
						foreach ($jual as $a) :
						?>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $a["COUNT(id_penjualan)"];?></div>
                                    <div>Total Penjualan </div>
                                </div>
                        <?php endforeach ; ?>
                            </div>
                        </div>
                        <a href="Laporan_jual.php">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        <div class="panel-heading">
                         ...
                         <?php
						$total=query("SELECT COUNT(id_buku) FROM buku");
						foreach ($total as $b) :
						?>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $b["COUNT(id_buku)"];?></div>
                                    <div>Total Buku</div>
                                </div>
                        <?php endforeach ; ?>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-blue">
                        ...
                        <?php
						$jumlah=query("SELECT SUM(jumlah) FROM penjualan");
						foreach ($jumlah as $c) :
						?>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $c["SUM(jumlah)"];?></div>
                                    <div>Buku Terjual</div>
                                </div>
                        <?php endforeach ; ?>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <?php
						$stok=query("SELECT SUM(stok) FROM buku");
						foreach ($stok as $d) :
						?>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $d["SUM(stok)"];?></div>
                                    <div>Stok Buku </div>
                                </div>
                        <?php endforeach ; ?>
                            </div>
