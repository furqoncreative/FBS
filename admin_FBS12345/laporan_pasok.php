   ...
   <!--/content-inner-->
	<div class="left-content">
	   <div class="inner-content">
		...
		<div class="fo-top-di">
			<div class="foot-top">
					<h2><i class="fa fa-list"></i>  Laporan Pemasokan</h2>
			</div>
			<div class="footer">
			<div style = "margin-left:20px;" id = "input">
				<div class = "col-xs-12 col-sm-3">
				<a href="cetak_pasok.php" class="btn btn-success" ><i class="fa fa-print"></i> CETAK</a>
				</div>
      ...
      $sql=query("SELECT * FROM pasok order by id_pasok desc");
      foreach($sql as $data):
      ?>
    <tr>
