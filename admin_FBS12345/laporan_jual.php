   ...
   <!--/content-inner-->
	<div class="left-content">
	   <div class="inner-content">
		...
		<div class="fo-top-di">
			<div class="foot-top">
					<h2><i class="fa fa-list"></i>  Laporan Penjualan</h2>
			</div>
			<div class="footer">
			<div style = "margin-left:20px;" id = "input">
				<div class = "col-xs-12 col-sm-3">
				<a href="cetak_jual.php" class="btn btn-success" ><i class="fa fa-print"></i> CETAK</a>
				</div>
				<div class="col-xs-12 col-sm-4">
				</div>
				<div class = "col-xs-12 col-sm-3">
				<form method="POST" action="hasil_jual.php">
					<input class = "form-control1" type ="text" placeholder="Cari Judul Buku Disini" name = "cari" required="" />
				</div>
      ...
      $sql=query("SELECT * FROM total order by id_penjualan desc");
      foreach($sql as $data):
      ?>
    <tr>
