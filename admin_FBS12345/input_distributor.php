...
if(isset($_POST['tambahdistributor'])) {

    if(tambahdistributor($_POST)> 0 ) {

        echo "<script>
             alert('DATA DISTRIBUTOR BERHASIL DITAMBAH !');
             document.location.href='Data_Distributor.php';
             </script>"; 
         }
        else {
            echo "<script>
             alert('DATA DISTRIBUTOR GAGAL DITAMBAH !');
             document.location.href='input_distributor.php';
             </script>";
        }
    }
?>
...
//koneksi berhsil
 ...
 $carikode = mysqli_query($koneksi, "SELECT max(id_distributor) from distributor") or die (mysql_error());
  // menjadikannya array
  ...
  if ($datakode) {
   ...
   $kode = $kode + 1;
   $kode_otomatis = "DSB-".str_pad($kode, 3, "0", STR_PAD_LEFT);
  } else {
   $kode_otomatis = "DSB-001";
  }
...
<div class="registration">
		...
		<h2><span><i class="fa fa-pencil"></i> Input Data Distributor Baru</span></h2>
		<script>
			(function() {
		 ...
		 <!-- Form -->
			<form method="POST" action="">
				<div>
					<label>
						<input placeholder="ID Distributor :" type="text" name="id_distributor" value="<?php echo $kode_otomatis;?>" readonly>
					</label>
				</div>
				<div>
					<label>
						<input placeholder="Nama Distributor :" type="text" name="nama_distributor" tabindex="1" required="" autofocus="">
					</label>
				</div>						
				<div>
					<input type="submit" name="tambahdistributor" tabindex="5" value="SUBMIT">
	...
	<div class="registration_left">
		<h2> .</h2>
		 ...
		 <!-- Form -->
		 		<div>
					<label>
						<input placeholder="Alamat Distributor :" type="text" name="alamat" tabindex="2" required="" >
					</label>
				</div>	
				<div>
					<label>
						<input placeholder="Telepon :" type="text" name="telepon" tabindex="3" required="">
					</label>
				</div>						
			</form>
			<!-- /Form -->
