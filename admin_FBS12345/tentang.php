	...
	<div class="content">
		...
		<div class="foot-top">
			<div class="container">
				...
				<h3>TENTANG</h3>
					<div class="foot-top">
									<p >Furqon Books Store adalah aplikasi penjualan toko buku berbasis web yang dirancang dengan sederhana namun telah cukup mumpuni untuk digunakan dalam toko buku sebenarnya. Aplikasi ini dibuat untuk UJI KOMPETENSI KEJURUAN saat saya sekolah di SMKN SITURAJA 2017.</p>
					</div>
					<br>
						<div class="col-md-4">
						<center><i class="fa fa-user"></i></center>
							<center><h5><b>Info Pribadi</b></h5></center>
							<table class="table">
								<tr>
									<td>TTL</td>
									<td>:</td>
									<td>Sumedang, 4 Juni 1999</td>
								</tr>
								<tr>
									<td>Motto Hidup</td>
									<td>:</td>
								...
								<tr>
									<td>Hobi</td>
									<td>:</td>
									<td>Desain Grafis & Editing</td>
								</tr>
							</table>
						</div>
						<div class="col-md-4">
						<center><i class="fa fa-envelope"></i></center>
							<center><h5>Kontak</h5></center>
							<table class="table">
								<tr>
									<td>Telp.</td>
									<td>:</td>
									<td>+62 815 6096 192</td>
								</tr>
								<tr>
									<td>Email</td>
									<td>:</td>
									<td><a href="mailto:akunkhusus42@gmail.com"> akunkhusus42 @gmail.com</a></td>
								</tr>
								<tr>
									<td>Alamat</td>
									<td>:</td>
									<td>Dsn. Karamat RT/RW 03/07 Ds. Cigintung Kec Cisitu</td>
								</tr>
							</table>
						</div>
						<div class="col-md-4">
						<center><i class="fa fa-comment"></i></center>
							<center><h5>Social Media</h5></center>
							<table class="table">
								<tr>
									<td>TTL</td>
									<td>:</td>
