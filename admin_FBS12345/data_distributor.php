   ...
   <!--/content-inner-->
    ...
    <tr>
      ...
      <td><?php echo '<a class="btn btn-xs btn-info" href="detail_distributor.php?id_distributor='. $data['id_distributor'] . '"><i alt="detail" class="fa fa-eye"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-primary" href="edit_distributor.php?id_distributor='. $data['id_distributor'] . '"><i alt="edit" class="fa fa-edit"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-danger" href="hapus_distributor.php?id_distributor='. $data['id_distributor'] . '"><i alt="hapus" class="fa fa-eraser"></i></a>&nbsp';?>
      </td>
    <?php
    endforeach;
    ?>
