   ...
   <!--/content-inner-->
	<div class="left-content">
	   <div class="inner-content">
		...
		<div class="fo-top-di">
			<div class="foot-top">
					<h2><i class="fa fa-book"></i>  Data Buku Pelajaran</h2>
			</div>
			<div class="footer">
			<div style = "margin-left:20px;" id = "input">
				...
				<div class = "col-xs-12 col-sm-4">
				<form method="POST" action="hasil_buku_pelajaran.php">
					<input class = "form-control" type ="search" placeholder="Cari Judul Buku Disini" name = "cari" required="" />
				</div>
      ...
      $sql=query("SELECT * FROM buku where jenis_buku='pelajaran' ");
      foreach($sql as $data):
      ?>
    <tr>
      ...
      <td><?php echo '<a class="btn btn-xs btn-info" href="detail_buku.php?id_buku='. $data['id_buku'] . '"><i alt="detail" class="fa fa-eye"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-primary" href="edit_buku.php?id_buku='. $data['id_buku'] . '"><i alt="edit" class="fa fa-edit"></i></a>&nbsp';?>
      	<?php echo '<a class="btn btn-xs btn-danger" href="hapus_buku.php?id_buku='. $data['id_buku'] . '"><i alt="hapus" class="fa fa-eraser"></i></a>&nbsp';?>
      </td>
    <?php
    endforeach;
    ?>
